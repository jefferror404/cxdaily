...
function updateFearGreedNeedle(value) {
    ...
    let label = "Netral";
    if (value <= 20) label = "Ketakutan Ekstrem";
    else if (value <= 40) label = "Ketakutan";
    else if (value <= 60) label = "Netral";
    else if (value <= 80) label = "Keserakahan";
    else label = "Keserakahan Ekstrem";
