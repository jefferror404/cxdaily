...
function updateFearGreedNeedle(value) {
    ...
    if (value <= 20) label = "Крайний страх";
    else if (value <= 40) label = "Страх";
    else if (value <= 60) label = "Нейтрально";
    else if (value <= 80) label = "Жадность";
    else label = "Крайняя жадность";
