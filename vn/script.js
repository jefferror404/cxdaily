...
function updateFearGreedNeedle(value) {
    ...
    let label = "Trung lập";
    if (value <= 20) label = "Cực kỳ sợ hãi";
    else if (value <= 40) label = "Sợ hãi";
    else if (value <= 60) label = "Trung lập";
    else if (value <= 80) label = "GreedTham lam";
    else label = "Cực kỳ tham lam";
