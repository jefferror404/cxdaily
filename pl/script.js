...
function updateFearGreedNeedle(value) {
    ...
    let label = "Neutralny";
    if (value <= 20) label = "Ekstremalny Strach";
    else if (value <= 40) label = "Strach";
    else if (value <= 60) label = "Neutralny";
    else if (value <= 80) label = "Chciwość";
    else label = "Ekstremalna Chciwość";
